...
<section id="main" class="product-detail thumbs-left product-image-thumbs product-thumbs-left" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 col-xs-12 col-sp-12">{* 
* @Module Name: AP Page Builder
* @Website: apollotheme.com - prestashop template provider
* @author Apollotheme <apollotheme@gmail.com>
* @copyright   Apollotheme
...
{/block}
                            </div><div class="col-xl-6 col-lg-5 col-md-12 col-sm-12 col-xs-12 col-sp-12">{* 
* @Module Name: AP Page Builder
* @Website: apollotheme.com - prestashop template provider
* @author Apollotheme <apollotheme@gmail.com>
* @copyright   Apollotheme
...
* @description: ApPageBuilder is module help you can build content for your shop
*}
{include file="sub/product_info/accordions.tpl"}{block name='product_accessories'}
      {if $accessories}
